...
CREATE TABLE `uc_account` (
  ...
  CONSTRAINT `Account_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `uc_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `uc_session` (
  ...
  CONSTRAINT `Session_userId_fkey` FOREIGN KEY (`userId`) REFERENCES `uc_user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
